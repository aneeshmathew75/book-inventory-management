            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="<?php echo $row_list['info_link'] ?>" type="link" class="btn btn-link">Info</a< /td>
                        <td><a href="update.php?id=<?php echo $row_list['id'] ?>" button type=" button" class="btn btn-primary">Update</button></button></td>
                    </tr>
                <?php
                }
                ?>
